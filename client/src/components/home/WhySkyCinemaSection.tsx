...
import { WHY_SKYCINEMA } from '@/lib/constants';
...
export default function WhySkyCinemaSection() {
  return (
    <section className="section-padding">
      <div className="container-luxury">
        <SectionHeading
          subtitle="The SkyCinema Difference"
          title="Why SkyCinema"
          description="We don't sell products. We craft experiences that transform the way you live, listen, and watch."
        />

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {WHY_SKYCINEMA.map((item, i) => (
            <motion.div
              key={item.title}
              ...
              className="group glass rounded-lg p-8 hover:border-gold/30 transition-all duration-500 hover:shadow-gold"
            >
